...
//import kh.edu.rupp.fe.dse.oursapplication.databinding.ActivityPayOutBinding
//import kh.edu.rupp.fe.dse.oursapplication.model.OrderDetails
//
...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = intent
        foodItemsName = intent.getStringArrayListExtra("FoodItemsName") ?: arrayListOf()
        foodItemsPrice = intent.getStringArrayListExtra("FoodItemsPrice") ?: arrayListOf()
        foodItemsImage = intent.getStringArrayListExtra("FoodItemsImage") ?: arrayListOf()
        foodItemsQuantity = intent.getIntegerArrayListExtra("FoodItemsQuantity") ?: arrayListOf()
    ...
    private fun placeOrder() {
        ...
        val orderDetails = OrderDetails(
            userId, name, foodItemsName, foodItemsImage, foodItemsPrice, foodItemsQuantity,
...
//    }
    private fun calculateTotalAmount(): Double {
        ...
        for (i in 0 until foodItemsPrice.size) {
            ...
            price = price.replace(Regex("[^\\d.]"), "")
            val priceDoubleValue = price.toDouble() // Convert to double to handle decimal values
            val quantity = foodItemsQuantity[i]
